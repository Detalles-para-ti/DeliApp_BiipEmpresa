import 'dart:convert';
import 'package:delivery_app_biip/common/functions/saveCurrentAPPLogin.dart';
import 'package:delivery_app_biip/common/functions/saveCurrentFBLogin.dart';
import 'package:delivery_app_biip/models/json/fbloginModel.dart';
          ...
          child: isLoggedIn ? Center(
            ...
            children: <Widget>[
              ...
              new Expanded(
                  flex: 3,
                  child: new Padding(
                    padding: EdgeInsets.all(ScreenUtil().setWidth(100.0)),
                    child: new Column(
                      children: <Widget>[
                        new Text(
                          'Al hacer clic en "Iniciar sesión", acepta nuestros Términos. Conozca cómo procesamos sus datos en nuestra Política de privacidad y Política de cookies. Una producción de Félix Minchón.',
